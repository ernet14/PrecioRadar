...
export function AlertList({ alerts, returnTo }: AlertListProps) {
  ...
  return (
    <section className="space-y-4">
      {alerts.map((alert) => (
        <Card
          className="overflow-hidden border-slate-200 shadow-[0_18px_45px_rgba(15,23,42,0.07)]"
          key={alert.id}
        >
          <div className="grid gap-5 p-4 lg:grid-cols-[96px_minmax(0,1fr)_240px] lg:p-5">
            <ProductImage
            ...
            <div className="min-w-0">
              ...
              <div className="mt-3 min-w-0">
                <Link
                  className="text-xl font-bold leading-7 text-slate-950 transition hover:text-blue-700"
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  ...
                  &middot; precio actual {alert.currentPriceLabel}
                </p>
              </div>
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-2">
                ...
                <div className="rounded-2xl border border-slate-100 bg-slate-50 p-4">
                  ...
                  <p className="text-sm leading-6 text-slate-500">
                    &Uacute;ltima notificaci&oacute;n: se mostrar&aacute; cuando la alerta
                    se cumpla.
                  </p>
                </div>
              </div>
